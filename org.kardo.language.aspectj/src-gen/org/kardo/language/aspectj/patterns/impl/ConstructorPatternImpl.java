 ...
 * <ul>
 *   <li>{@link org.kardo.language.aspectj.patterns.impl.ConstructorPatternImpl#getModifiers <em>Modifiers</em>}</li>
 *   <li>{@link org.kardo.language.aspectj.patterns.impl.ConstructorPatternImpl#getDeclaringType <em>Declaring Type</em>}</li>
 *   <li>{@link org.kardo.language.aspectj.patterns.impl.ConstructorPatternImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstructorPatternImpl extends AbstractMethodPatternImpl implements ConstructorPattern
{
  ...
  public EList<WildcardOrTypePattern> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<WildcardOrTypePattern>(WildcardOrTypePattern.class, this, PatternsPackage.CONSTRUCTOR_PATTERN__PARAMETERS);
    }
    return parameters;
  }
