...
public interface PointcutsFactory extends EFactory
{
   ...
   * @generated
   */
  PointcutsFactory eINSTANCE = org.kardo.language.aspectj.pointcuts.impl.PointcutsFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Set Pointcut</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Set Pointcut</em>'.
   * @generated
   */
  ...
  /**
   * Returns a new object of class '<em>Returning Pointcut</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Returning Pointcut</em>'.
   * @generated
   */
  ReturningPointcut createReturningPointcut();
