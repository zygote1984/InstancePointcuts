...
public class PointcutsFactoryImpl extends EFactoryImpl implements PointcutsFactory
{
  ...
  public static PointcutsFactory init()
  {
    try
    {
      PointcutsFactory thePointcutsFactory = (PointcutsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.emftext.org/language/aspectj/pointcuts"); 
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case PointcutsPackage.SET_POINTCUT: return createSetPointcut();
      ...
      case PointcutsPackage.RETURNING_POINTCUT: return createReturningPointcut();
      default:
   ...
   * @generated
   */
  public ReturningPointcut createReturningPointcut()
  {
    ReturningPointcutImpl returningPointcut = new ReturningPointcutImpl();
    return returningPointcut;
  }
