...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CFlow Pointcut</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.kardo.language.aspectj.pointcuts.impl.CFlowPointcutImpl#getPointcut <em>Pointcut</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CFlowPointcutImpl extends PrimitivePointcutImpl implements CFlowPointcut
{
  /**
  ...
  {
    return PointcutsPackage.Literals.CFLOW_POINTCUT;
  }
    ...
    if (pointcut != null && pointcut.eIsProxy())
    {
      ...
      if (pointcut != oldPointcut)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PointcutsPackage.CFLOW_POINTCUT__POINTCUT, oldPointcut, pointcut));
      }
    }
    return pointcut;
  }
  ...
  public void setPointcut(Pointcut newPointcut)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PointcutsPackage.CFLOW_POINTCUT__POINTCUT, oldPointcut, pointcut));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PointcutsPackage.CFLOW_POINTCUT__POINTCUT:
