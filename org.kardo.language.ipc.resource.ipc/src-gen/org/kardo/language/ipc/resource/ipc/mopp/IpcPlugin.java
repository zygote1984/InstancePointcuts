 ...
 */
public class IpcPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.kardo.language.ipc.resource.ipc";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, IpcPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, IpcPlugin.PLUGIN_ID, message);
		}
		final IpcPlugin pluginInstance = IpcPlugin.getDefault();
