 ...
 */
public class IpcEnumerationTerminal extends org.kardo.language.ipc.resource.ipc.grammar.IpcTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public IpcEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.kardo.language.ipc.resource.ipc.grammar.IpcCardinality cardinality, int mandatoryOccurrencesAfter) {
