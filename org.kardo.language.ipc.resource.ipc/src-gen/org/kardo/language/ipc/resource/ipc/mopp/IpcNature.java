...
public class IpcNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.kardo.language.ipc.resource.ipc.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.kardo.language.ipc.resource.ipc.mopp.IpcBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.kardo.language.ipc.resource.ipc.mopp.IpcBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
