...
public class IpcRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.kardo.language.ipc.resource.ipc.mopp.IpcPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.kardo.language.ipc.resource.ipc.mopp.IpcPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
