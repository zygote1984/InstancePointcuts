 ...
 */
public class IpcDefaultTokenResolver implements org.kardo.language.ipc.resource.ipc.IIpcTokenResolver {
	 ...
	 */
	public IpcDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public IpcDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.kardo.language.ipc.resource.ipc.IIpcTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.kardo.language.ipc.resource.ipc.IIpcTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.kardo.language.ipc.resource.ipc.grammar.IpcGrammarInformationProvider.INSTANCE.getKeywords()) {
