...
public class IpcResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.kardo.language.ipc.resource.ipc.util.IpcInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.kardo.language.ipc.resource.ipc.util.IpcInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.kardo.language.ipc.resource.ipc.mopp.IpcResource getResource(java.io.File file) {
	...
	public static org.kardo.language.ipc.resource.ipc.mopp.IpcResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.kardo.language.ipc.resource.ipc.mopp.IpcMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.kardo.language.ipc.resource.ipc.mopp.IpcResource) resource;
	}
	...
	public static org.eclipse.emf.ecore.resource.Resource getResource(String text) {
		org.kardo.language.ipc.resource.ipc.mopp.IpcMetaInformation metaInformation = new org.kardo.language.ipc.resource.ipc.mopp.IpcMetaInformation();
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.kardo.language.ipc.resource.ipc.IIpcTextResource resource = (org.kardo.language.ipc.resource.ipc.IIpcTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.kardo.language.ipc.resource.ipc.IIpcTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.kardo.language.ipc.resource.ipc.IIpcTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
