...
public class IpcLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.kardo.language.ipc.resource.ipc.mopp.IpcLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.kardo.language.ipc.resource.ipc.mopp.IpcLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.kardo.language.ipc.resource.ipc.mopp.IpcLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.kardo.language.ipc.resource.ipc.mopp.IpcLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.kardo.language.ipc.resource.ipc.grammar.IpcSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.kardo.language.ipc.resource.ipc.grammar.IpcGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.kardo.language.ipc.resource.ipc.mopp.IpcLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.kardo.language.ipc.resource.ipc.grammar.IpcSyntaxElement syntaxElement = org.kardo.language.ipc.resource.ipc.grammar.IpcGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.kardo.language.ipc.resource.ipc.grammar.IpcPlaceholder) {
			org.kardo.language.ipc.resource.ipc.grammar.IpcPlaceholder placeholder = (org.kardo.language.ipc.resource.ipc.grammar.IpcPlaceholder) syntaxElement;
			org.kardo.language.ipc.resource.ipc.IIpcTokenResolver tokenResolver = new org.kardo.language.ipc.resource.ipc.mopp.IpcTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.kardo.language.ipc.resource.ipc.IIpcTokenResolveResult result = new org.kardo.language.ipc.resource.ipc.mopp.IpcTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.kardo.language.ipc.resource.ipc.mopp.IpcLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.kardo.language.ipc.resource.ipc.mopp.IpcLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
