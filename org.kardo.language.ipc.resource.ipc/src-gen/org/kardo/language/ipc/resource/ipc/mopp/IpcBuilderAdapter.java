...
public class IpcBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.kardo.language.ipc.resource.ipc.builder";
	
	private org.kardo.language.ipc.resource.ipc.IIpcBuilder defaultBuilder = new org.kardo.language.ipc.resource.ipc.mopp.IpcBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.kardo.language.ipc.resource.ipc.IIpcBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.kardo.language.ipc.resource.ipc.mopp.IpcResource customResource = (org.kardo.language.ipc.resource.ipc.mopp.IpcResource) resourceSet.getResource(uri, true);
			new org.kardo.language.ipc.resource.ipc.mopp.IpcMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.kardo.language.ipc.resource.ipc.IIpcBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.kardo.language.ipc.resource.ipc.mopp.IpcMarkerHelper().getMarkerID(org.kardo.language.ipc.resource.ipc.IpcEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.kardo.language.ipc.resource.ipc.mopp.IpcTaskItemBuilder taskItemBuilder = new org.kardo.language.ipc.resource.ipc.mopp.IpcTaskItemBuilder();
		new org.kardo.language.ipc.resource.ipc.mopp.IpcMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.kardo.language.ipc.resource.ipc.mopp.IpcMetaInformation().getSyntaxName())) {
