...
public class IpcStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.kardo.language.ipc.resource.ipc.IIpcFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.kardo.language.ipc.resource.ipc.IIpcFunction1<String, T> toStringFunction) {
