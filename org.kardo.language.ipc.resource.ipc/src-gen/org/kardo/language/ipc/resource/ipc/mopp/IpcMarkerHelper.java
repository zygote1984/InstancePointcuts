 ...
 * contains <code>org.kardo.language.ipc.resource.ipc.IIpcTextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class IpcMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.kardo.language.ipc.resource.ipc.mopp.IpcPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.kardo.language.ipc.resource.ipc.IIpcCommand<Object>> commands = new java.util.ArrayList<org.kardo.language.ipc.resource.ipc.IIpcCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.kardo.language.ipc.resource.ipc.IIpcCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.kardo.language.ipc.resource.ipc.IIpcCommand<Object>> commandsToProcess = new java.util.ArrayList<org.kardo.language.ipc.resource.ipc.IIpcCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.kardo.language.ipc.resource.ipc.IIpcCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.kardo.language.ipc.resource.ipc.IIpcTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.kardo.language.ipc.resource.ipc.IIpcTextDiagnostic diagnostic) {
		final org.kardo.language.ipc.resource.ipc.IIpcProblem problem = diagnostic.getProblem();
		org.kardo.language.ipc.resource.ipc.IpcEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.kardo.language.ipc.resource.ipc.IIpcCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.kardo.language.ipc.resource.ipc.IpcEProblemSeverity.ERROR) {
					...
					org.kardo.language.ipc.resource.ipc.IIpcTextDiagnostic textDiagnostic = (org.kardo.language.ipc.resource.ipc.IIpcTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.kardo.language.ipc.resource.ipc.mopp.IpcResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.kardo.language.ipc.resource.ipc.mopp.IpcResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.kardo.language.ipc.resource.ipc.IIpcQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.kardo.language.ipc.resource.ipc.util.IpcStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.kardo.language.ipc.resource.ipc.IpcEProblemType nextType : org.kardo.language.ipc.resource.ipc.IpcEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.kardo.language.ipc.resource.ipc.IpcEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.kardo.language.ipc.resource.ipc.IpcEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.kardo.language.ipc.resource.ipc.IpcEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.kardo.language.ipc.resource.ipc.util.IpcRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.kardo.language.ipc.resource.ipc.IIpcCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.kardo.language.ipc.resource.ipc.mopp.IpcPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
