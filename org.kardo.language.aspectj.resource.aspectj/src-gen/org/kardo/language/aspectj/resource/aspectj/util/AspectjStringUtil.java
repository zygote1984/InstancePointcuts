 ...
 */
public class AspectjStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.kardo.language.aspectj.resource.aspectj.IAspectjFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.kardo.language.aspectj.resource.aspectj.IAspectjFunction1<String, T> toStringFunction) {
