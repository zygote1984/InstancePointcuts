...
public class AspectjTokenStyleInformationProvider {
	...
	public org.kardo.language.aspectj.resource.aspectj.IAspectjTokenStyle getDefaultTokenStyle(String tokenName) {
		if ("aspect".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0xFF, 0x00, 0x11}, null, true, false, false, false);
		}
		...
		if ("->".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x00, 0x00, 0x00}, null, true, false, false, false);
		}
		if ("ML_COMMENT".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x00, 0x80, 0x00}, null, false, true, false, false);
		}
		if ("SL_COMMENT".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x00, 0x00, 0x80}, null, false, true, false, false);
		}
		if ("STRING_LITERAL".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x2A, 0x00, 0xFF}, null, false, false, false, false);
		}
		if ("IDENTIFIER".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x00, 0x00, 0x00}, null, false, false, false, false);
		}
		if ("abstract".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x7F, 0x00, 0x55}, null, true, false, false, false);
		}
		...
		if ("finally".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		...
		if ("TASK_ITEM".equals(tokenName)) {
			return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenStyle(new int[] {0x7F, 0x9F, 0xBF}, null, true, false, false, false);
		}
