 ...
 */
public class AspectjRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.kardo.language.aspectj.resource.aspectj.mopp.AspectjPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.kardo.language.aspectj.resource.aspectj.mopp.AspectjPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
