...
public class AspectjNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.kardo.language.aspectj.resource.aspectj.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.kardo.language.aspectj.resource.aspectj.mopp.AspectjBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.kardo.language.aspectj.resource.aspectj.mopp.AspectjBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
