...
/**
 * AspectjLayoutInformation objects are used to store layout information that is
 ...
 * AspectjLayoutInformations are aggregated in LayoutInformationAdapters. One
 * AspectjLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class AspectjLayoutInformation {
	 ...
	 */
	private final org.kardo.language.aspectj.resource.aspectj.grammar.AspectjSyntaxElement syntaxElement;
	...
	public AspectjLayoutInformation(org.kardo.language.aspectj.resource.aspectj.grammar.AspectjSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.kardo.language.aspectj.resource.aspectj.grammar.AspectjSyntaxElement getSyntaxElement() {
