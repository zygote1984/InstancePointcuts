 ...
 */
public class AspectjResourceUtil {
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.ResourceSet resourceSet) {
		return new org.kardo.language.aspectj.resource.aspectj.util.AspectjInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static java.util.Set<org.eclipse.emf.ecore.EObject> findUnresolvedProxies(org.eclipse.emf.ecore.resource.Resource resource) {
		return new org.kardo.language.aspectj.resource.aspectj.util.AspectjInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResource getResource(java.io.File file) {
	...
	public static org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResource) resource;
	}
	...
	public static org.eclipse.emf.ecore.resource.Resource getResource(String text) {
		org.kardo.language.aspectj.resource.aspectj.mopp.AspectjMetaInformation metaInformation = new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjMetaInformation();
	 ...
	 */
	public static org.kardo.language.aspectj.commons.AspectJCompilationUnit getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.kardo.language.aspectj.commons.AspectJCompilationUnit getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.kardo.language.aspectj.commons.AspectJCompilationUnit) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.kardo.language.aspectj.commons.AspectJCompilationUnit getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.kardo.language.aspectj.resource.aspectj.IAspectjTextResource resource = (org.kardo.language.aspectj.resource.aspectj.IAspectjTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.kardo.language.aspectj.resource.aspectj.IAspectjTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.kardo.language.aspectj.resource.aspectj.IAspectjTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {
