 ...
 */
public interface IAspectjTextParser extends org.kardo.language.aspectj.resource.aspectj.IAspectjConfigurable {
	 ...
	 */
	public org.kardo.language.aspectj.resource.aspectj.IAspectjParseResult parse();
	 ...
	 * will not be needed.
	 */
	public java.util.List<org.kardo.language.aspectj.resource.aspectj.mopp.AspectjExpectedTerminal> parseToExpectedElements(org.eclipse.emf.ecore.EClass type, org.kardo.language.aspectj.resource.aspectj.IAspectjTextResource dummyResource, int cursorOffset);
