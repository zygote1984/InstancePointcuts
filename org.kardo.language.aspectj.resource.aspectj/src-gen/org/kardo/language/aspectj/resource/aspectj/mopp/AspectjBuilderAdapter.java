...
public class AspectjBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.kardo.language.aspectj.resource.aspectj.builder";
	
	private org.kardo.language.aspectj.resource.aspectj.IAspectjBuilder defaultBuilder = new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.kardo.language.aspectj.resource.aspectj.IAspectjBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResource customResource = (org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResource) resourceSet.getResource(uri, true);
			new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.kardo.language.aspectj.resource.aspectj.IAspectjBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjMarkerHelper().getMarkerID(org.kardo.language.aspectj.resource.aspectj.AspectjEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTaskItemBuilder taskItemBuilder = new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTaskItemBuilder();
		new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjMetaInformation().getSyntaxName())) {
