 ...
 */
public class AspectjLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.kardo.language.aspectj.resource.aspectj.mopp.AspectjLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.kardo.language.aspectj.resource.aspectj.mopp.AspectjLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.kardo.language.aspectj.resource.aspectj.mopp.AspectjLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.kardo.language.aspectj.resource.aspectj.mopp.AspectjLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.kardo.language.aspectj.resource.aspectj.grammar.AspectjSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.kardo.language.aspectj.resource.aspectj.grammar.AspectjGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.kardo.language.aspectj.resource.aspectj.mopp.AspectjLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.kardo.language.aspectj.resource.aspectj.grammar.AspectjSyntaxElement syntaxElement = org.kardo.language.aspectj.resource.aspectj.grammar.AspectjGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.kardo.language.aspectj.resource.aspectj.grammar.AspectjPlaceholder) {
			org.kardo.language.aspectj.resource.aspectj.grammar.AspectjPlaceholder placeholder = (org.kardo.language.aspectj.resource.aspectj.grammar.AspectjPlaceholder) syntaxElement;
			org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver tokenResolver = new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolveResult result = new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.kardo.language.aspectj.resource.aspectj.mopp.AspectjLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
