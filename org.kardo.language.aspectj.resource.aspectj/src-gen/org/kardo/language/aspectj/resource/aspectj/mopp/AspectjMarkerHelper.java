 ...
 * contains
 * <code>org.kardo.language.aspectj.resource.aspectj.IAspectjTextDiagnostic</code>s
 * it uses the more precise information of this extended diagnostic type.
 */
public class AspectjMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.kardo.language.aspectj.resource.aspectj.mopp.AspectjPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object>> commands = new java.util.ArrayList<org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object>> commandsToProcess = new java.util.ArrayList<org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.kardo.language.aspectj.resource.aspectj.IAspectjTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.kardo.language.aspectj.resource.aspectj.IAspectjTextDiagnostic diagnostic) {
		final org.kardo.language.aspectj.resource.aspectj.IAspectjProblem problem = diagnostic.getProblem();
		org.kardo.language.aspectj.resource.aspectj.AspectjEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.kardo.language.aspectj.resource.aspectj.AspectjEProblemSeverity.ERROR) {
					...
					org.kardo.language.aspectj.resource.aspectj.IAspectjTextDiagnostic textDiagnostic = (org.kardo.language.aspectj.resource.aspectj.IAspectjTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.kardo.language.aspectj.resource.aspectj.IAspectjQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.kardo.language.aspectj.resource.aspectj.util.AspectjStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.kardo.language.aspectj.resource.aspectj.AspectjEProblemType nextType : org.kardo.language.aspectj.resource.aspectj.AspectjEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.kardo.language.aspectj.resource.aspectj.AspectjEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.kardo.language.aspectj.resource.aspectj.AspectjEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.kardo.language.aspectj.resource.aspectj.AspectjEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.kardo.language.aspectj.resource.aspectj.util.AspectjRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.kardo.language.aspectj.resource.aspectj.IAspectjCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.kardo.language.aspectj.resource.aspectj.mopp.AspectjPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
