...
public abstract class AspectjQuickFix implements org.kardo.language.aspectj.resource.aspectj.IAspectjQuickFix {
	...
	public AspectjQuickFix(String displayString, String imageKey, org.eclipse.emf.ecore.EObject contextObject) {
		this(displayString, imageKey, java.util.Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public AspectjQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public AspectjQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects, org.eclipse.emf.ecore.resource.Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.kardo.language.aspectj.resource.aspectj.util.AspectjRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}
