...
public class AspectjResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public AspectjResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.kardo.language.aspectj.resource.aspectj.util.AspectjRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.kardo.language.aspectj.resource.aspectj.util.AspectjEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjResourceFactory());
		}
	}
