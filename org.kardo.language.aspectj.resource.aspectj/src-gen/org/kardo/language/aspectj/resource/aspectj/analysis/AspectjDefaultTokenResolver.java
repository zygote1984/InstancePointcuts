 ...
 */
public class AspectjDefaultTokenResolver implements org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver {
	 ...
	 */
	public AspectjDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public AspectjDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.kardo.language.aspectj.resource.aspectj.grammar.AspectjGrammarInformationProvider.INSTANCE.getKeywords()) {
