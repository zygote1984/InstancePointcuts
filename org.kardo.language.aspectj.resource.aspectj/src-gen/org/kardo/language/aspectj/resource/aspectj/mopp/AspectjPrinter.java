...
public class AspectjPrinter implements org.kardo.language.aspectj.resource.aspectj.IAspectjTextPrinter {
	
	protected org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolverFactory tokenResolverFactory = new org.kardo.language.aspectj.resource.aspectj.mopp.AspectjTokenResolverFactory();
	...
	public AspectjPrinter(java.io.OutputStream outputStream, org.kardo.language.aspectj.resource.aspectj.IAspectjTextResource resource) {
		super();
	...
	public void print_org_kardo_language_aspectj_commons_AspectJCompilationUnit_0(org.kardo.language.aspectj.commons.AspectJCompilationUnit element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("IDENTIFIER");
	...
	public void print_org_emftext_language_java_references_StringReference(org.emftext.language.java.references.StringReference element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("STRING_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_DecimalLongLiteral(org.emftext.language.java.literals.DecimalLongLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("DECIMAL_LONG_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_DecimalFloatLiteral(org.emftext.language.java.literals.DecimalFloatLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("DECIMAL_FLOAT_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_DecimalIntegerLiteral(org.emftext.language.java.literals.DecimalIntegerLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("DECIMAL_INTEGER_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_DecimalDoubleLiteral(org.emftext.language.java.literals.DecimalDoubleLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("DECIMAL_DOUBLE_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_HexLongLiteral(org.emftext.language.java.literals.HexLongLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("HEX_LONG_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_HexFloatLiteral(org.emftext.language.java.literals.HexFloatLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("HEX_FLOAT_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_HexDoubleLiteral(org.emftext.language.java.literals.HexDoubleLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("HEX_DOUBLE_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_HexIntegerLiteral(org.emftext.language.java.literals.HexIntegerLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("HEX_INTEGER_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_OctalLongLiteral(org.emftext.language.java.literals.OctalLongLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCTAL_LONG_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_OctalIntegerLiteral(org.emftext.language.java.literals.OctalIntegerLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCTAL_INTEGER_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_CharacterLiteral(org.emftext.language.java.literals.CharacterLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("CHARACTER_LITERAL");
				resolver.setOptions(getOptions());
	...
	public void print_org_emftext_language_java_literals_BooleanLiteral(org.emftext.language.java.literals.BooleanLiteral element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.kardo.language.aspectj.resource.aspectj.IAspectjTokenResolver resolver = tokenResolverFactory.createTokenResolver("BOOLEAN_LITERAL");
				resolver.setOptions(getOptions());
