...
aspect Kardo 
{
	...
	public void createAttachmentForP1Aa(){
		org.alia4j.aspectj.parser.ast.AJPointcutParser parser_p1_aa = zygote.instancepc.lib.alia4j.ALIA4JParser.parseExpression("call( ) ");
		...
		org.alia4j.liam.Attachment attachment_p1_aa = zygote.instancepc.lib.alia4j.ALIA4JAttachmentModule.createStaticAttachment(spec_p1_aa, P1AdviceTarget.class, 
									"addToSet", new Class[] {Integer.class}, org.alia4j.liam.ScheduleInfo.AFTER);
